...
# app config
home_page = st.Page("pages/home.py", title="Home", url_path="home", icon=":material/home:")
...
page_nav = st.navigation([home_page, goat_page, cur_dri_page, cur_con_page, com_dri_page, com_con_page])
page_nav.run()
